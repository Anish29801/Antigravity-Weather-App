    ...
    <div style={styles.authPageContainer}>
      <div className="glass-panel" style={styles.authCard}>
        <div style={styles.authHeader}>
          ...
          <p style={styles.subtitle}>ESTABLISH NEW BEACON</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          <div style={styles.inputGroup}>
            <label style={styles.label} htmlFor="name">
              <i className="fa-solid fa-signature" style={styles.inputIcon}></i> COMMANDER CODENAME (NAME)
            </label>
            <input
              type="text"
              id="name"
              placeholder="e.g. Commander Case"
              value={name}
          ...
          <div style={styles.inputGroup}>
            <label style={styles.label} htmlFor="email">
              <i className="fa-solid fa-envelope" style={styles.inputIcon}></i> TELEMETRY IDENTIFIER (EMAIL)
            </label>
            <input
              type="email"
              id="email"
          ...
          >
            {submitting ? 'CALIBRATING...' : 'SECURE CONFIG & JOIN'}
          </button>
        </form>

        <div style={styles.footer}>
          <p style={styles.footerText}>
            Already have active telemetry?{' '}
            <Link to="/login" style={styles.link} onClick={() => playClickSound(1000, 700, 0.05)}>
              Sync Existing Node
            </Link>
          </p>
        </div>
